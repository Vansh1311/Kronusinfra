...
const ProjectCard = ({ project }) => (
  <div className="shrink-0 p-4 w-80 md:w-96">
    <div className="relative rounded-xl overflow-hidden transform hover:scale-[1.03] transition duration-500 shadow-2xl group">
      ...
      <div className="absolute inset-0 bg-linear-to-t from-black/20 via-transparent to-transparent opacity-0 group-hover:opacity-40 transition-opacity duration-500 rounded-xl"></div>
...
const ProjectsSlider = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-white " >
      ...
      <button className="mt-12 mx-auto block px-6 py-3 bg-[#b5c577] font-semibold rounded-full shadow-lg hover:bg-[#a1b64d] transition" style={{ fontFamily: 'Poppins, sans-serif', color: '#000000' }}>
          View All Projects
        </button>
    </section>
  );
