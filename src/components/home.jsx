...
const Home = () => {
  ...
  return (
    <>
          ...
          <div className="max-w-xl">
            ...
            <div className="py-20">
              ...
              <div className="mt-8 flex gap-4">
                <button className="bg-[#b5c577] hover:bg-[#a7bc53] text-black px-8 py-3 text-lg rounded-lg shadow-lg transition duration-300">
                  Explore Projects
                </button>
      ...
      <section className="relative bottom-30 lg:bottom-14 bg-white z-10">
        <JourneyNumbers />
      </section>

      <section className="relative bottom-30 z-10">
        <Achievement />
      </section>
      ...
      <section className="relative bottom-30 bg-white z-10">
        <Podcasts/>
      </section>

      <section className="relative bottom-30 bg-white z-20">
        <ProjectsSlider />
      </section>
      ...
      <img src="https://simplemaps.com/static/demos/resources/svg-library/svgs/world.svg" alt="world map" className="absolute bottom-0 left-0 w-full h-48 object-cover pointer-events-none select-none" />
      </section>
