  ...
  return (
    <section className="relative w-full min-h-screen pt-28 lg:pt-32 overflow-hidden bg-gray-50">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-12 flex flex-col items-center text-center">
        ...
        <FadeInText delay={0}>
          <h1 className="text-black text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight h-32" style={{ textShadow: "0 4px 10px rgba(0,0,0,0.6)" }}> 
            GET A <span className="text-amber-600" > HOME</span>
          </h1>
        </FadeInText>
        ...
        <FadeInText delay={600}>
          <button className="mt-8 px-8 py-4 rounded-full bg-[#b5c577] text-gray-900 font-bold uppercase tracking-wider shadow-lg hover:bg-[#ab875f] transition-transform duration-300">
            Explore Projects
          </button>
        </FadeInText>
      </div>
      ...
      <div className="absolute bottom-40 lg:bottom-14 left-0 w-full text-center">
        <h3 className="text-4xl sm:text-5xl lg:text-7xl  font-extrabold uppercase tracking-tight leading-tight text-gray-300">
          Your ideal home awaits
        </h3>
        <h4 className="text-2xl sm:text-3xl lg:text-5xl font-light uppercase tracking-widest text-[#ab875f]  opacity-90 drop-shadow-[0_0_12px_rgba(165,120,70,0.5)]">
